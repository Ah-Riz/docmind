...
6. OpenAI (`OPENAI_MODEL`, default `gpt-4o-mini`) returns JSON: flow, error_summary, fixes.
...
| OpenAI explain | `backend/app/ai/explain.py` |
...
- Missing tx → 404
- RPC / OpenAI transport failures → 502
